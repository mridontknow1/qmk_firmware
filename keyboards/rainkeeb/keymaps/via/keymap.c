...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    * |L Ctrl | L Alt | L Gui |  Shift/Space  |     MO(1)     |     Space     | R Gui | R Alt | R Ctrl|
    * `-----------------------------------------------------------------------------------------------'
    */
	[_BASE] = LAYOUT( /* Layer 0 */
		...
		KC_LCTRL, 	KC_LALT,	KC_LGUI, 		SFT_T(KC_SPC),		MO(1),			KC_SPC,	            KC_RGUI, 	KC_RALT,    KC_RCTL
	),
...
/*
        render_logo_line0();
        oled_set_cursor(7,0);
        oled_write_ln_P(PSTR("rainkeeb"), false);
        render_logo_line1();
        oled_set_cursor(7,1);
        oled_write_P(PSTR("Layer: "), false);
        switch (get_highest_layer(layer_state)) {
